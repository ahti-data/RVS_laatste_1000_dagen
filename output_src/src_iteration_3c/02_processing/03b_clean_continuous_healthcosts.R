...
rinpersoon_set_2023 <- unique(dt_overlijden_with_matched[
  cohort == "2023"]$rinpersoon)


# just load from 2020, such that cohort 2019 does not get created
dt_msz_addon <- load_dataset(2020:2023, "MSZDGADDONGENEESMVEKTTAB", cols = c( 
