...
for (i in 1) {
  ...
  for (yr in years) {
    ...
    dt[, ':='(
      ...
      heeft_aaa_0303_totaal = as.integer(spec == '0303' & diag == '0405'),

      heeft_aaa_0303_kijkoperatie = as.integer(spec == '0303' & diag == '0405'  &
                                                 is_aaa_kijkoperatie == 1),

      heeft_aaa_0303_operatie = as.integer(spec == '0303' & diag == '0405' &
                                             is_aaa_operatie == 1),
    ...
    dt[, c('vektmszspecialismediagnosecombinatie', 'spec', 'diag', 'is_heup',
